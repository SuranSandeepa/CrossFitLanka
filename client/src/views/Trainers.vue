...
-->
  ...
  export default {
    ...
    downloadPdf(){
      ...
      doc.setFontSize(25);
      doc.text("CrossFitLanka Fymnasium", 50,10);
        ...
        body:[
          {
            name: "A.B.C Silva",
            contact:"0774568974	",
            qualification:"Certificate course in physical fitness instructor training",
          },

          {
            name: "D.A.Jayasinghe",
            contact:"0775893857",
            qualification:"National Academy of Sports Medicine (NASM)",
          },
          
          {
            name: "M.G Heshan De Silva",
            contact:"0773894832",
            qualification:"The National Council on Strength & Fitness (NCSF)",
          },
          {
            name: "K.P De Zoysa",
            contact:"0774985789",
